...
int main(int argc, char *argv[]){
    ...
    if (strcmp(argv[1], "-awil") == 0)
    {
        printf("Average words in line: %.2f\n", average_words(file));
        return 0;
    }
...
float average_words(FILE *file){
    ...
    average_words_in_line = (float) words / count_line ;

    return average_words_in_line;
